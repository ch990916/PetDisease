...
<body>
	<div class="grid grid-cols-2 mt-2">
		<div class="col-auto pr-4" align='right'>
			...
			<div id="default-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    			<div class="relative w-full max-w-2xl max-h-full">
        			<div class="relative w-6/12 bg-white shadow dark:bg-gray-700" align="left">
						...
						<form name="loginForm" action="login" onsubmit="return loginCheck();" method="post">
							<div class="grid grid-rows-2 bg-indigo-100">
								<div class="p-2">
<<<<<<< HEAD
									<p class="font-bold">ID&nbsp;<input class="p-2 h-6 w-32" style="appearance:none;" name="pm_id" placeholder="Username" autofocus></p>
									<p class="font-bold">PW&nbsp;<input class="p-2 mt-1 h-6 w-32" style="appearance:none;" name="pm_pw" type="password"></p>
=======
...
>>>>>>> 990a617caa8e478fab531be833ffe15ba353fd13
								</div>
